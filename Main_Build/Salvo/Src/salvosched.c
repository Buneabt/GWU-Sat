  ...
  while (OSlostTicks) {
    ...
    while (OScTcbP) {
      ...
      //  timeouts are enabled.
        ...
        OSLeaveCritical();
        //aek 20150814 ... The section below was added on behalf of Salvo for MSP430X
        //  with RA430 -- it still needs to be worked into the overall release.
        //#if ((OSCTXSW_METHOD == OSVIA_OSDISPATCH) || (OSCTXSW_METHOD == OSVIA_OSDISPATCH_WLABEL) )
        //OSCallCycTmr();
