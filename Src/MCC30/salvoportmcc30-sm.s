...
;
; $Source: C:\\RCS\\D\\Pumpkin\\Salvo\\Src\\MCC30\\salvoportmcc30-sm.s,v $
; $Author: aek $
; $Revision: 3.5 $
; $Date: 2016-03-05 12:25:33-08 $
;
; Context switcher for PIC24/PIC24E & dsPIC33/dsPIC33E when using Microchip 
;  MPLAB C30 C compiler for the small code model. 
;
...
; **********************************************************/
        ...
        .equ    SAVED_REGS_OFFSET,6 ; in bytes, offset from start of tcb
                                    ;  to savedRegs block.
...
;  Destroys:  W0, W1
;
;  Speed:    11 cycles, including an RCALL to this
...
_OSDispatch:
        ...
        mov.w     [w0+4],w1       ; branch to task's start/resume
                                  ;  address via 16-bit address
...
;  void OSReturn (void)
;
;   Simple exit back to scheduler without making changes
;    to tcb.
;
;**                                                       **
;****                                                   ****
...
_OSCtxSw:
        ...
        mov.w     w1,[w0+4]       ; write to task's tFP
